...
const keywords_one = `This namespace covers topics in biomechanics , kinematics , kinetics , joint angles , joint torque , range of motion ,
...
const keywords_two = `This namespace covers topics in nutrition , diet , macronutrients , micronutrients ,
...
const keywords_three = `This namespace covers topics in muscle recovery , muscle repair , muscle damage ,
...
const keywords_four = `This namespace covers topics in cardiovascular fitness , aerobic fitness , anaerobic fitness ,
